...
class FilmServiceTest {
    ...
    public void testFilmService() {
        ...
        assertTrue(filmStorage.findAll().contains(film2));
    }
    ...
    public void validationTest() {
        ...
        Throwable exception1 = assertThrows(ValidationException.class, () -> filmStorage.create(film3));
        ...
        Throwable exception2 = assertThrows(ValidationException.class, () -> filmStorage.create(film4));
